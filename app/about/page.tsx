  ...
  return (
    <main className="inner-page">
      ...
      <section className="quality-system">
        ...
        <div className="process-list">{processSteps.map((step, i) => <article key={step} data-reveal><b>0{i + 1}</b><h3>{step}</h3><p>{["验证材料品质与批次一致性", "完成核心真空工艺与密封控制", "保障靶材连接精度与可靠性", "完成关键组件装配与电气验证", "全参数检测与出厂前稳定性验证"][i]}</p></article>)}</div>
      </section>
